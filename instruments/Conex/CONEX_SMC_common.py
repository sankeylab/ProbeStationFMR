...
class CONEXSMC(MotionControllers):
    def __init__(self, COMPort):
        super(CONEXSMC,self).__init__(COMPort)
    ...
    def get_homesearch_timeout(self,axis):
        self.axis=str(axis)
        return self.write_read(self.axis+"OT?")
        
    def set_homesearch_timeout(self,axis,value):
        self.axis=str(axis)
        self.value=str(value)
    ...
    def get_homesearch_velocity(self, axis):
        self.axis=str(axis)
        return self.write_read(self.axis+"OH?")
        
    def set_homesearch_velocity(self, axis,value):
        self.axis=str(axis)
        self.value=str(value)
